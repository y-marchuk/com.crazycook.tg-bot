...
public class Buttons {
    ...
    public static void respondToStartButton(SendMessage sendMessage, List<List<InlineKeyboardButton>> buttons){
        ...
        buttonRow2.add(priceButton(sendMessage, buttons));
    ...
    public static InlineKeyboardButton priceButton (SendMessage sendMessage, List<List<InlineKeyboardButton>> buttons) {
    ...
    public static void respondToPriceButton(SendMessage sendMessage, List<List<InlineKeyboardButton>> buttons){
        sendMessage.setText("Маємо в асортименті три типи боксів: \n" +
